...
import bottomBannerM from '../assets/bottomBannerM.png'
        ...
        <PrincipalLayout>
            ...
            <section className="relative mx-4 md:mx-10 ">
                ...
                <div className="block md:hidden">
                    <img src={antiM} className="rounded-lg"/>
                </div>
            </section>
            ...
            <section className="flex flex-col md:flex-row gap-4 justify-between mx-4 md:mx-10">
                <div className="bg-white rounded-xl shadow-md p-4 max-w-md mx-auto">
                    ...
                    <p className="text-black mb-6">La selección ideal de productos para tu cuidado en todo momento.</p>

                    <div className="grid grid-cols-3 gap-4">
                        <div className="flex flex-col items-center">
                            <div className="w-20 h-20 md:w-24 md:h-24 bg-white rounded-full border border-gray-200 flex items-center justify-center">
                            ...
                            <p className="text-sm font-medium mt-2">Cabeza y general</p>
                        </div>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-sm font-medium mt-2">Tos</p>
                        </div>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-sm font-medium mt-2">Multivitamínicos</p>
                        </div>
                    </div>
                </div>
                 {/*SEgunda CARD */}
                 <div className="bg-white rounded-xl shadow-md p-4 max-w-md mx-auto">
                    ...
                    <p className="text-black mb-6">Todo un mundo de productos para los consentidos de la casa.</p>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-sm font-medium mt-2">Pañales</p>
                        </div>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-sm md:whitespace-nowrap text-center font-medium mt-2">Leches infantiles</p>
                        </div>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-sm md:whitespace-nowrap text-center font-medium mt-2 ">Pañitos húmedos</p>
                        </div>
                    </div>
                </div>
                {/*tercera Card */}
                <div className="bg-white rounded-xl shadow-md p-4 max-w-md mx-auto">
                    ...
                    <p className="text-black mb-6">Encuentra aquí las marcas destacadas para cuidar de ti y tu familia.</p>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-sm font-medium mt-2">Tratamiento</p>
                        </div>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-sm text-center font-medium mt-2">Shampoo y acondicionador</p>
                        </div>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-sm text-center font-medium mt-2">Tratamiento corporal</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="relative mx-4 my-4 md:mx-10 ">
                ...
                <div className="block md:hidden">
                    <img src={BannerCSVM} className="rounded-lg"/>
                </div>
            </section>
            ...
            <section className="relative mx-4 my-4 md:mx-10 ">
                <div className="hidden md:block">
                    <img src={bottomBanner} className="rounded-lg"/>
                </div>
                <div className="block md:hidden">
                    <img src={bottomBannerM} className="rounded-lg"/>
                </div>
            </section>
        </PrincipalLayout>
    )
